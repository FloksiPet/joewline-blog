...
| Посилання на щойно опублікований допис показує 404 | Не баг роутингу — GitHub Pages деплоїться ~30-60с після push, а бот шле посилання одразу. Почекай і онови сторінку; тепер сама 404-сторінка теж оформлена в стилі сайту (`site/src/pages/404.astro`), а не дефолтна сторінка хостингу |
